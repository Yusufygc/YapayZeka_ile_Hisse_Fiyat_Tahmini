...
- Ensembles can improve reports and backtests. Only `Ensemble Inverse RMSE` and
  `Ensemble Cash-Gated` are eligible as production ensemble leaders. Other
  ensemble variants remain report-only.
