# -*- coding: utf-8 -*-
"""
conftest.py -- Pytest konfigurasyon ve opsiyonel bagimlilık taslakları
======================================================================
Sandbox veya CI ortamlarında kurulmamış olabilecek opsiyonel kutuphaneler
(tensorflow, yfinance, xgboost, ta, lightgbm, prophet, optuna, torch) icin
sys.modules duzeyinde MagicMock taslakları olusturur.

Bu dosya pytest tarafından herhangi bir test modulu import edilmeden ONCE
yuklenir; dolayısıyla tum smoke testleri icin koruma saglar.
"""
