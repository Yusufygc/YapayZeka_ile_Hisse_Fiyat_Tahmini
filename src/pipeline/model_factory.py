...
def build_deep_config(config: dict) -> dict:
    ...
    for section in ("lstm", "lstm_lite", "attention_lstm_v2"):
...
def make_attention_lstm_v2(deep_config: dict, stage: str) -> AttentionLSTMV2Model:
    cfg = deep_config["attention_lstm_v2"]
